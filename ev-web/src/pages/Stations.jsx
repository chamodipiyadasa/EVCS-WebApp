  ...
  return (
    <div className="space-y-3">
      <div className="flex justify-between items-center">
        ...
        {/* use relative route so this links to /app/stations/new when rendered inside /app */}
        <Link to="new" className="bg-blue-600 text-white px-3 py-2 rounded">Add Station</Link>
      </div>
          ...
          {items.map(s=>(
            <tr key={s.id} className="border-t">
              ...
              <td className="space-x-2">
                {/* relative edit link -> /app/stations/:id */}
                <Link className="underline" to={`${s.id}`}>Edit</Link>
